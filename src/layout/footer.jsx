    ...
    <div className='container mx-auto'>
      ...
      <div className='logo'>
        ...
        <ul className='flex flex-row gap-2 mt-3'>
          <li><Link><TiSocialFacebook className="bg-background3 rounded-xl text-white size-6" /></Link></li>
          <li><Link><TiSocialTwitter className="bg-background3 rounded-xl text-white p-0.5 size-6" /></Link></li>
          <li><Link><TiSocialLinkedin className="bg-background3 rounded-xl text-white size-6" /></Link></li>
          <li><Link><TiSocialInstagram className="bg-background3 rounded-xl text-white p-0.5 size-6" /></Link></li>
          <li><Link><TiSocialYoutube className="bg-background3 rounded-xl text-white p-1 size-6" /></Link></li>
        </ul>
      </div>
